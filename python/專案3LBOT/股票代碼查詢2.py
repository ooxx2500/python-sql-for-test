# -*- coding: utf-8 -*-
"""
Created on Thu Jul 23 13:11:24 2020
...
2.將所有欄位轉換為格式化
"""
for i,data in enumerate(df["成交張數"]):
    if data==0:
        df=df.drop(index=i)
...
mask=((df_final["外資買超占比"]>0.3) & (df_final["成交張數"]>5000))
print("籌碼分析: 外資買超比:30%以上 & 成交張數大於5000張")
df2=df_final[mask].head(10)
...
mask_1=((df_final["投信買超占比"]>0.3) & (df_final["成交張數"]>5000))
print("籌碼分析: 投信買超比:30%以上 & 成交張數大於5000張")
df3=df_final[mask_1].head(10)
